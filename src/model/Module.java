...
public class Module implements Comparable<Module>, Serializable {
    ...
    private String deliveryToString;
    ...
    public boolean isMandatory() {
    	if (mandatory == true) {
    		mandatoryToString = "Yes";
    	} else {
    		mandatoryToString = "No";
    	} 
        return mandatory;
    }
    ...
    public Schedule getDelivery() {
    	if (delivery == Schedule.TERM_1) {
    		deliveryToString = "Term 1";
    	} else if (delivery == Schedule.TERM_2) {
    		deliveryToString = "Term 2";
    	} else {
    		deliveryToString = "Year Long";
    	} 
        return delivery;
    }
    ...
    public String actualToString() {
        return "Module Code: " + moduleCode + ", Module Name: " + moduleName + ", Credits: " + moduleCredits + ", Mandatory on Course: " + mandatoryToString + ", Delivery: " + deliveryToString + "\n";
    }
