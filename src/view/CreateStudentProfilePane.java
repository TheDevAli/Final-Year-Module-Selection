...
public class CreateStudentProfilePane extends GridPane {
    ...
    public void setData(StudentProfile model) {
        cboCourses.getSelectionModel().select(model.getStudentCourse());
        inputDate.setValue(model.getSubmissionDate());
        txtFirstName.setText(model.getStudentName().getFirstName());
        txtSurname.setText(model.getStudentName().getFamilyName());
        txtPnumber.setText(model.getStudentPnumber());
        txtEmail.setText(model.getStudentEmail());
